...
function printBarcodesFromItems(items, format) {
  ...
  var html = [
    ...
    'svg { display: block; width: 100% !important; height: 20px !important; }',
    '.bottom-info { display: flex; justify-content: space-between; font-size: 5pt; font-weight: normal; padding: 0 0.5mm; }',
    '</style></head><body>',
    labels,
    '<script>',
    'document.querySelectorAll(".bc").forEach(function(el) {',
    '  JsBarcode(el, el.dataset.code, { format: "CODE128", width: 0.7, height: 20, displayValue: false, margin: 0 });',
    '});',

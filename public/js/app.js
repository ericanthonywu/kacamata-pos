...
function printBarcodesFromItems(items, format) {
  ...
  var html = [
    ...
    '<style>',
    '@page { size: 73.7mm 20.3mm; margin: 0; }',
    '* { margin: 0; padding: 0; box-sizing: border-box; }',
    'body { background: #fff; color: #000; font-family: Arial, sans-serif; width: 73.7mm; overflow: hidden; margin: 0; }',
    '.label { width: 73.7mm; height: 20.3mm; display: flex; gap: 3mm; page-break-after: always; overflow: hidden; }',
    '.half { width: 35mm; min-width: 0; flex-shrink: 0; height: 20.3mm; display: flex; flex-direction: column; justify-content: flex-start; padding: 1mm 1.5mm; overflow: hidden; }',
    '.name { font-size: 6pt; font-weight: bold; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-transform: uppercase; margin-bottom: 0.5mm; text-align: left; }',
    '.bc-wrapper { display: flex; justify-content: center; align-items: center; margin-bottom: 0.5mm; overflow: hidden; width: 100%; }',
    'svg { display: block; }',
    '.bottom-info { display: flex; justify-content: space-between; font-size: 5pt; font-weight: normal; padding: 0 0.5mm; }',
    '</style></head><body>',
    labels,
    '<script>',
    ...
    '  if (w && h) { el.setAttribute("viewBox", "0 0 " + w + " " + h); el.removeAttribute("width"); el.removeAttribute("height"); el.style.width = "100%"; el.style.height = "auto"; el.style.maxHeight = "12mm"; }',
    '});',
